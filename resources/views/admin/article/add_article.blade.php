...
<div class="container">
  ...
  <h1>Article</h1>
  <form action="/admin/create_article" method="post" enctype="multipart/form-data">
      @csrf
      <h1>title</h1>
      <input class="form-control" type="text" placeholder="Default input" name="title" aria-label="default input example">
      <h1>image_article</h1>
      ...
      <textarea id="mytextarea" type="text" class="form-control" id="contents" name="contents" style="height: 800px"></textarea>
      <h1>active</h1>            
